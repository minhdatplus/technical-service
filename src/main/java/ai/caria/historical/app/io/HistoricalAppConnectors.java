...
public interface HistoricalAppConnectors extends Connectors {
    ...
    @Endpoint(path = "swagger", method = GET, request = SwaggerRequest.class, prometheusPrefix = "swagger")
    void swagger(Message message, Deferred<Message, Exception> deferred);
}
